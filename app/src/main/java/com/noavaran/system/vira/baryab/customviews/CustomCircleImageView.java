...
public class CustomCircleImageView extends AppCompatImageView {
    ...
    public CustomCircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.CustomCircleImageView_civ_circle_background_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CustomCircleImageView_civ_circle_background_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        } else if (a.hasValue(R.styleable.CustomCircleImageView_civ_fill_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CustomCircleImageView_civ_fill_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        }
