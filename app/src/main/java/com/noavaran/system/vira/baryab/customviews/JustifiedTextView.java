...
import com.noavaran.system.vira.baryab.customviews.justifiedtextview.XmlToClassAttribHandler;
...
//			setText(XmlToClassAttribHandler.GetAttributeStringValue(mContext, attrs, namespace, key, ""));
    ...
    private void setCustomFont(Context ctx, AttributeSet attrs) {
        TypedArray a = ctx.obtainStyledAttributes(attrs, R.styleable.JustifiedTextView);
        String customFont = a.getString(R.styleable.JustifiedTextView_jtvCustomFont);
