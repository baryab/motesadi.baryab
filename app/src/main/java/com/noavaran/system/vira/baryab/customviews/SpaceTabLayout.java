...
import com.noavaran.system.vira.baryab.customviews.spacetablayout.PagerAdapter;
...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private CustomTextView tabOneTextView;
    private CustomTextView tabTwoTextView;
    private CustomTextView tabThreeTextView;
    private CustomTextView tabFourTextView;
    private CustomTextView tabFiveTextView;
    ...
    private void init() {
        ...
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_one);
    ...
    public void initialize(ViewPager viewPager, FragmentManager fragmentManager, List<Fragment> fragments) {
        ...
        if (numberOfTabs == 3 && !iconOnly) {
            ...
            tabOneTextView = (CustomTextView) tabOne.getCustomView().findViewById(R.id.tabTextView);
            tabTwoTextView = (CustomTextView) tabTwo.getCustomView().findViewById(R.id.tabTextView);
            tabThreeTextView = (CustomTextView) tabThree.getCustomView().findViewById(R.id.tabTextView);
        ...
        } else if (numberOfTabs == 4 && !iconOnly) {
            tabOne.setCustomView(R.layout.icon_text_tab_layout);
            tabTwo.setCustomView(R.layout.icon_text_tab_layout);
            tabThree.setCustomView(R.layout.icon_text_tab_layout);
            ...
            tabTwoTextView = (CustomTextView) tabTwo.getCustomView().findViewById(R.id.tabTextView);
            tabThreeTextView = (CustomTextView) tabThree.getCustomView().findViewById(R.id.tabTextView);
            tabFourTextView = (CustomTextView) tabFour.getCustomView().findViewById(R.id.tabTextView);

            tabOneImageView = (ImageView) tabOne.getCustomView().findViewById(R.id.tabImageView);
            tabTwoImageView = (ImageView) tabTwo.getCustomView().findViewById(R.id.tabImageView);
            tabThreeImageView = (ImageView) tabThree.getCustomView().findViewById(R.id.tabImageView);
            tabFourImageView = (ImageView) tabFour.getCustomView().findViewById(R.id.tabImageView);
        } else if (numberOfTabs == 5 && !iconOnly) {
            tabOne.setCustomView(R.layout.icon_text_tab_layout);
            tabTwo.setCustomView(R.layout.icon_text_tab_layout);
            tabThree.setCustomView(R.layout.icon_text_tab_layout);
            tabFour.setCustomView(R.layout.icon_text_tab_layout);
            ...
            tabThreeTextView = (CustomTextView) tabThree.getCustomView().findViewById(R.id.tabTextView);
            tabFourTextView = (CustomTextView) tabFour.getCustomView().findViewById(R.id.tabTextView);
            tabFiveTextView = (CustomTextView) tabFive.getCustomView().findViewById(R.id.tabTextView);
