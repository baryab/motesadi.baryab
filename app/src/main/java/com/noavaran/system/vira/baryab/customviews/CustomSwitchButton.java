...
public class CustomSwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkLineColor = optColor(typedArray,
                R.styleable.CustomSwitchButton_sb_checkline_color,
                Color.WHITE);//Color.WHITE;

        checkLineWidth = optPixelSize(typedArray,
                R.styleable.CustomSwitchButton_sb_checkline_width,
