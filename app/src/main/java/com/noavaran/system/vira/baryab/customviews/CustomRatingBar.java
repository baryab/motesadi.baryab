...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.ic_rating_star_on;
    private int mStarOffResource = R.drawable.ic_rating_star_off;
    private int mStarHalfResource = R.drawable.ic_rating_star_half;
